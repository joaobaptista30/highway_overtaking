...
gps.enable(timestep)
# Noise settings
mean = 7.5      # mean of noise
std_dev = 2.5   # standard deviation in meters (adjust as needed)
def add_noise(value):
...
while driver.step() != -1:
    ...
    if state == CRUISE:
        ...
        if front_distance < SAFE_DISTANCE:
            ...
            maneuver_start_distance = raw_front_distance
            state = OVERTAKE
...
with open("../supervisor_rulebased_nonoptimal2/results_rulebased_nonoptimal2.txt", "a") as file:
...
with open("../supervisor_rulebased_nonoptimal2/results_rulebased_nonoptimal2.csv", "a") as file:
    file.write(f"{success},{maneuver_end_time - maneuver_start_time},{min_distance_raw},{maneuver_start_distance},{maneuver_start_velocity},\n")
