...
while driver.step() != -1:
    ...
    if success == True:
        ...
        print("Maneuver Time = ", maneuver_end_time - maneuver_start_time)
...
with open("results_rulebased_baseline.txt", "a") as file:
    file.write(f"{success},{maneuver_end_time - maneuver_start_time},{min_distance}\n")


with open("results_rulebased_baseline.csv", "a") as file:
    file.write(f"{success},{maneuver_end_time - maneuver_start_time},{min_distance}\n")
