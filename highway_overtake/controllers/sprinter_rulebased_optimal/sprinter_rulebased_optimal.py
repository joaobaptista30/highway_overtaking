...
while driver.step() != -1:
    ...
    if success == True:
        ...
        print("[INFO]: Minimum Distance = ", min_distance)
...
with open("../supervisor_rulebased_baseline/results_rulebased_baseline.txt", "a") as file:
    file.write(f"{success},{maneuver_end_time - maneuver_start_time},{min_distance},{maneuver_start_distance},{maneuver_start_velocity},\n")


with open("../supervisor_rulebased_baseline/results_rulebased_baseline.csv", "a") as file:
    file.write(f"{success},{maneuver_end_time - maneuver_start_time},{min_distance},{maneuver_start_distance},{maneuver_start_velocity},\n")
